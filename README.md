...
在浏览器中直接打开 http://10.193.21.115:3000 即可访问传统版可视化仪表板。
...
部署完成后，在浏览器中打开 http://10.193.21.115:3001 即可访问现代版可视化仪表板。
...
- 传统版：在浏览器中打开 http://10.193.21.115:3000 访问传统版仪表板
- 现代版：在浏览器中打开 http://10.193.21.115:3001 访问现代版仪表板（需要先按照上述步骤部署现代版前端）
