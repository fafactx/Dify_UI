...
echo "  或者直接运行 $PROJECT_ROOT/scripts/deploy/stop.sh [--port=$FRONTEND_PORT]"
echo ""
echo "提示: 如果需要安装依赖，请使用 $PROJECT_ROOT/scripts/deploy/deploy.sh --install"

# 使脚本可执行
chmod +x "$SCRIPT_DIR/deploy.sh"
chmod +x "$SCRIPT_DIR/stop.sh"
chmod +x "$SCRIPT_DIR/frontend-deploy.sh"
chmod +x "$SCRIPT_DIR/frontend-nginx-deploy.sh"
chmod +x "$SCRIPT_DIR/frontend-nginx-stop.sh"
